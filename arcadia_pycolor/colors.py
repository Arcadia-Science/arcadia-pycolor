...
cividis = {"color_dict": crow | forest | canary | satin, "values": [0, 0.39, 0.85, 1]}
...
yellows = {"color_dict": cocoa | canary | oat | paper, "values": [0.0, 0.76, 0.9, 1.0]}
greens = {"color_dict": yucca | lime | paper, "values": [0, 0.7, 1]}
teals = {"color_dict": depths | seaweed | paper, "values": [0, 0.42, 1]}
blues = {
    "color_dict": concord | aegean | vitalblue | paper,
    "values": [0, 0.47, 0.66, 1.0],
}
purples = {"color_dict": royal | aster | wish | paper, "values": [0, 0.4, 0.74, 1.0]}
magentas = {"color_dict": carmine | pitaya | rose | paper, "values": [0, 0.44, 0.73, 1]}
...
aegeanamber = {"color_dict": aegean | paper | amber, "values": [0, 0.5, 1]}
astercanary = {"color_dict": aster | paper | canary, "values": [0, 0.5, 1]}
limerose = {"color_dict": lime | paper | rose, "values": [0, 0.5, 1]}
seaweedtangerine = {"color_dict": seaweed | paper | tangerine, "values": [0, 0.5, 1]}
seaweedrose = {"color_dict": seaweed | paper | rose, "values": [0, 0.5, 1]}
limetangerine = {"color_dict": lime | paper | tangerine, "values": [0, 0.5, 1]}

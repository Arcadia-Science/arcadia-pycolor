...
tangerine = HexCode("tangerine", "#FFB883")
...
chateau = HexCode("chateau", "#B9AFA7")
...
# Background colors.
parchment = HexCode("parchment", "#FEF7F1")
zephyr = HexCode("zephyr", "#F4FBFE")
lichen = HexCode("lichen", "#F7FBEF")
dawn = HexCode("dawn", "#F8F4F1")

# Shades.
lapis = HexCode("lapis", "#2B66A2")
dusk = HexCode("dusk", "#094468")
cinnabar = HexCode("cinnabar", "#9E3F41")
melon = HexCode("melon", "#FFCFAF")
...
blossom = HexCode("blossom", "#F4CAE3")

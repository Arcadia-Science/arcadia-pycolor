...
# Other named colors
white = HexCode("w", "#FFFFFF")
red = HexCode("r", "#FF0000")
green = HexCode("g", "#00FF00")
blue = HexCode("b", "#0000FF")
cyan = HexCode("c", "#00FFFF")
magenta = HexCode("m", "#FF00FF")
yellow = HexCode("y", "#FFFF00")
black = HexCode("k", "#000000")

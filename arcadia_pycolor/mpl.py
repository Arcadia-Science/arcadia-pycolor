...
def set_xticklabel_font(axis: Union[Axes, None] = None, font: str = DEFAULT_FONT) -> None:
    "Set the font of the x and y tick labels."
    ax = _find_axis(axis)
...
def set_ticklabel_font(axis: Union[Axes, None] = None, font: str = DEFAULT_FONT) -> None:
    "Set the font of the x and y tick labels."
    ax = _find_axis(axis)
